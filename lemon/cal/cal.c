...
#define YY_ERROR_ACTION      46
#define YY_ACCEPT_ACTION     47
#define YY_NO_ACTION         48
#define YY_MIN_REDUCE        49
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    12,    8,    9,    6,    7,    5,    8,    9,    6,    7,
 /*    10 */     5,   40,   11,    2,   47,    1,   41,    3,    8,    9,
 /*    20 */     6,    7,    5,   61,    6,    7,    5,   13,   37,   20,
 /*    30 */    43,   18,   19,    4,    4,   38,   38,    8,    9,    6,
 /*    40 */     7,    5,   23,   14,   10,    3,   21,   22,   16,   17,
 /*    50 */    15,    5,   45,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */    18,    1,    2,    3,    4,    5,    1,    2,    3,    4,
 /*    10 */     5,   11,   18,   13,   15,   16,   11,   10,    1,    2,
 /*    20 */     3,    4,    5,    0,    3,    4,    5,   18,   11,   18,
 /*    30 */     7,    8,    8,   10,   10,   12,   12,    1,    2,    3,
 /*    40 */     4,    5,   17,   18,    9,   10,   18,   18,   18,   18,
 /*    50 */    18,    5,    7,   19,   19,   19,   19,   19,   19,   19,
...
static const unsigned char yy_shift_ofst[] = {
 /*     0 */    53,   23,   24,   24,   24,   24,   24,   24,   24,   24,
 /*    10 */    24,    0,    5,   17,   36,   36,   21,   21,   35,    7,
 /*    20 */    46,   46,   46,   45,
};
...
static const signed char yy_reduce_ofst[] = {
 /*     0 */    -1,   25,  -18,   -6,    9,   11,   28,   29,   30,   31,
 /*    10 */    32,
};
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    63,   46,   46,   46,   46,   46,   46,   46,   46,   46,
 /*    10 */    46,   46,   46,   46,   50,   49,   52,   51,   58,   58,
 /*    20 */    55,   54,   53,   46,
};
...
static const char *const yyRuleName[] = {
 ...
 /*   8 */ "expr ::= NUM",
 /*   9 */ "expr ::= NAME",
 /*  10 */ "expr ::= NAME LP expr RP",
 /*  11 */ "expr ::= NAME LP expr COMMA expr RP",
 /*  12 */ "main ::= in",
 /*  13 */ "in ::= in NEWLINE",
 /*  14 */ "in ::=",
 /*  15 */ "in ::= in program NEWLINE",
};
#endif /* NDEBUG */
...
static const struct {
  ...
  {   17,   -3 }, /* (0) program ::= NAME EQ expr */
  {   17,   -1 }, /* (1) program ::= expr */
  {   18,   -3 }, /* (2) expr ::= expr MINUS expr */
  {   18,   -3 }, /* (3) expr ::= expr PLUS expr */
  {   18,   -3 }, /* (4) expr ::= expr TIMES expr */
  {   18,   -3 }, /* (5) expr ::= expr DIVIDE expr */
  {   18,   -3 }, /* (6) expr ::= expr POW expr */
  {   18,   -3 }, /* (7) expr ::= LP expr RP */
  {   18,   -1 }, /* (8) expr ::= NUM */
  {   18,   -1 }, /* (9) expr ::= NAME */
  {   18,   -4 }, /* (10) expr ::= NAME LP expr RP */
  {   18,   -6 }, /* (11) expr ::= NAME LP expr COMMA expr RP */
  {   15,   -1 }, /* (12) main ::= in */
  {   16,   -2 }, /* (13) in ::= in NEWLINE */
  {   16,    0 }, /* (14) in ::= */
  {   16,   -3 }, /* (15) in ::= in program NEWLINE */
};
...
#line 70 "cal.y"
{yylhsminor.yy0.value = yymsp[-2].minor.yy0.value - yymsp[0].minor.yy0.value;}
#line 940 "cal.c"
...
#line 78 "cal.y"
{yylhsminor.yy0.value = pow(yymsp[-2].minor.yy0.value, yymsp[0].minor.yy0.value);}
#line 968 "cal.c"
...
#line 80 "cal.y"
{yymsp[-2].minor.yy0.value = yymsp[-1].minor.yy0.value;}
#line 976 "cal.c"
...
#line 85 "cal.y"
{
        if(yymsp[0].minor.yy0.symt->funcptr || yymsp[0].minor.yy0.symt->funcptr2){
            printf("%s is a function! Must type in like a number!\n", yymsp[0].minor.yy0.symt->name);
            yylhsminor.yy0.value = 0.0;
        }else{
            yylhsminor.yy0.value = yymsp[0].minor.yy0.symt->value;
        }
    }
#line 996 "cal.c"
  yymsp[0].minor.yy0 = yylhsminor.yy0;
...
#line 1010 "cal.c"
  ...
  yymsp[-3].minor.yy0 = yylhsminor.yy0;
        break;
      case 11: /* expr ::= NAME LP expr COMMA expr RP */
#line 106 "cal.y"
{
        if(yymsp[-5].minor.yy0.symt->funcptr2){
            yylhsminor.yy0.value = (yymsp[-5].minor.yy0.symt->funcptr2) (yymsp[-3].minor.yy0.value, yymsp[-1].minor.yy0.value);
        }else{
            printf("%s function undifined! func2 \n",yymsp[-5].minor.yy0.symt->name);
            exit(1);
        }
    }
#line 1025 "cal.c"
  ...
  yymsp[-5].minor.yy0 = yylhsminor.yy0;
        break;
      case 13: /* in ::= in NEWLINE */
      case 15: /* in ::= in program NEWLINE */ yytestcase(yyruleno==15);
#line 54 "cal.y"
{
}
#line 1036 "cal.c"
  yy_destructor(yypParser,7,&yymsp[0].minor);
        break;
      default:
      /* (12) main ::= in */ yytestcase(yyruleno==12);
      /* (14) in ::= */ yytestcase(yyruleno==14);
        break;
/********** End reduce actions ************************************************/
  };
